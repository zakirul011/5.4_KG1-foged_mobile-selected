(function ($) {
	...
	// custom tab
	tabFunc(document.querySelectorAll('.single-wheel-nav'), document.querySelectorAll('.single-wheel-tab'))
	...
	const selectableList = document.querySelectorAll('.color ul li, .size ul li')
